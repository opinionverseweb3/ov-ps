...
#ifndef CFSDK_SWIFT_H
#define CFSDK_SWIFT_H
...
SWIFT_CLASS("_TtC5CFSDK23AmazonPayViewController")
@interface AmazonPayViewController : UIViewController
...
@interface AmazonPayViewController (SWIFT_EXTENSION(CFSDK)) <SFSafariViewControllerDelegate>
- (void)safariViewControllerDidFinish:(SFSafariViewController * _Nonnull)controller;
@end



SWIFT_CLASS("_TtC5CFSDK16CFPaymentService")
@interface CFPaymentService : NSObject
...
typedef SWIFT_ENUM(NSInteger, CF_ENV, open) {
  CF_ENVTEST = 0,
  CF_ENVPROD = 1,
};


SWIFT_PROTOCOL("_TtP5CFSDK14ResultDelegate_")
